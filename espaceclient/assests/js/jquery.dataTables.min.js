...
e.sInstance,this.oApi._fnJsonString(i),e.iCookieDuration,e.sCookiePrefix,e.fnCookieCallback)},fnStateSaveParams:null,iCookieDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iScrollLoadGap:100,iTabIndex:0,oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"première",sLast:"dernier",sNext:"suivant",sPrevious:"précédent"},sEmptyTable:"Pas de données disponibles dans le tableau",sInfo:"projection _START_ à _END_ de _TOTAL_ entrées",
