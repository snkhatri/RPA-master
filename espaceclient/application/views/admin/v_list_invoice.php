...
function delete_confirm()
{
	...
	//user pressed cancel. Do nothing
                ...
                <div class="row box1">
                    <div class="row">
                       <h5 class="name_ad"><span><?php echo _invoice;?></span> <span style="float:right; margin-right:20px;"> <a href="<?php echo site_url();?>admin/invoice/form"><?php echo _create_invoice;?></a></span></h5>
...
<td class="dash_date"><?php echo date('d/m/Y',strtotime($result->date_time));?></td>
