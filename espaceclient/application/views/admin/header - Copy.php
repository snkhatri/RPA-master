...
<div class="row">
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="col-md-4 col-sm-4 col-xs-4">
	        <img src="<?php echo $this->config->item('assests');?>image/logo.jpg" title="logo" class="img-responsive" /> 
        </div>
...
<!--Container start-->
    ...
    <div class="row">
        <div class="col-md-4">
        <ul class="v-menu">
        <form class="form-search" method="post" id="s" action="" class="left_border" style="margin-top:10px;">
        <button type="submit" class="search_manu"></button>
        <input type="text" class="input-medium" name="s" placeholder="<?php echo _search;?>" value="">
		</form>
...
<!--            <li><a href="<?php //echo site_url();?>admin/"><img src="<?php //echo $this->config->item('assests');?>image/<?php //if($page_url=='dashboard'){?>tab.png<?php //}else{?>table.png<?php //}?>" height="68" width="68" alt="star"/><span class="lr"><?php //echo _document;?></span><span class="text-right arrow_right"><img src="<?php //echo $this->config->item('assests');?>image/v_arrow.png" height="11" width="7" align="absmiddle"></span></a></li>
-->        </ul>
        </div>
        <div class="col-md-8">
...
<?php endif; ?>
 <div class="mon">
            ...
            <div class="col-md-3">
            <img src="<?php echo $this->config->item('assests'); ?>uploads/client/<?php echo $admin_result->image;?>" height="42" width="42" alt="ADMIN" style="border-radius: 50%;
background: #4679BD;"/>
            </div>
            <li class="dropdown col-md-6" style="list-style:none; padding:12px;">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo _admin;?><span class="caret"></span></a>
