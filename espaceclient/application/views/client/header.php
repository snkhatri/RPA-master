...
<div class="row">
    <div class="col-md-6 col-sm-12 col-xs-12">
        <div class="col-md-4 col-sm-3 col-xs-5">
	        <img src="<?php echo $this->config->item('assests');?>image/logo.png" title="logo"  height="92" width="129" class="img-responsive" /> 
        </div>
...
<?php
$admin_details1 = $this->session->userdata('admin_details');
$admin_id1 = $admin_details1['id'];
$single_result1 = $this->m_client->single_client($admin_id1);
$image1 = $single_result1->image;
$name = $single_result1->name;
...
<div class="container_fluid" style="background: #444444;">
    <div class="container">
        ...
        <div class="col-md-10">
            ...
            <p style="float: left;">&nbsp;&nbsp;<img src="<?php echo $this->config->item('assests'); ?>uploads/client/<?php echo $image1;?>" height="42" width="42" alt="ADMIN" style="border-radius: 50%; background: #4679BD;" align="absmiddle"/>&nbsp;&nbsp;&nbsp;&nbsp;</p>
                <p style="float: left;">
                <ul>
                <li class="dropdown" style="list-style:none; font-size: 12px; margin-right: 20px !important; margin-top:10px;">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" style="color: #fff; text-transform: none; text-decoration: none;"><?php echo $name;?><span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
               <li><a href="<?php echo site_url();?>client/profile/change_password"><?php echo _changa_password;?></a></li>
...
<!--Container start-->
    ...
    <div class="row">
        ...
        <ul class="v-menu">
            ...
            <li><a href="<?php echo site_url();?>client/invoice"><img src="<?php echo $this->config->item('assests');?>image/<?php if($page_url=='invoice'){?>stars.png<?php }else{?>star.png<?php }?>" height="68" width="68" alt="star"/><span class="lr"><?php echo _my_bills;?></span><span class="text-right arrow_right"><img src="<?php echo $this->config->item('assests');?>image/v_arrow.png" height="11" width="7"/></span></a></li>
           
             <li><a href="<?php echo site_url();?>client/profile"><img src="<?php echo $this->config->item('assests');?>image/<?php if($page_url=='profile'){?>admin3_pen.png<?php }else{?>creer.png<?php }?>" height="68" width="68" alt="star"/><span class="lr"><?php echo _my_account;?></span><span class="text-right arrow_right"><img src="<?php echo $this->config->item('assests');?>image/v_arrow.png" height="11" width="7"/></span></a></li>
         <li><a href="<?php echo site_url();?>client/invoice/document"><img src="<?php echo $this->config->item('assests');?>image/<?php if($page_url=='document'){?>tab.png<?php }else{?>table.png<?php }?>" height="68" width="68" alt="star"/><span class="lr"><?php echo _document;?></span><span class="text-right arrow_right"><img src="<?php echo $this->config->item('assests');?>image/v_arrow.png" height="11" width="7" align="absmiddle"></span></a></li>
